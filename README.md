...
# sails-generate-gruntfile-liticed
...
<!--
```sh
$ npm install sails-generate-gruntfile-liticed
```
-->
...
sailsgen(require('sails-generate-gruntfile-liticed'), scope, function (err) {
	if (err) throw err;
...
```sh
$ git clone YOUR_FORK_OF_THIS_REPO sails-generate-gruntfile-liticed-fork
$ cd sails-generate-gruntfile-liticed-fork
$ npm install
$ node ./bin
```
